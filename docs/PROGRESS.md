...
**실제 도면(새 참고도면 2층) 검증: 방 51개 중 44개 성공 · 인접 44쌍 · 면적 상식적**
(탈의실 3~4㎡ / 조제실 18㎡ / 동결건조실 66㎡ — 그림으로 눈 검증 완료)
...
남은 7개: 무균 갱의/퇴실 구역의 작은 방들. 라벨이 다닥다닥 붙어 옆방을 잡는다.
→ 라벨 대표점 대신 **라벨 박스 중심**을 쓰거나, 방 라벨의 지시선(leader)을 따라가야 한다. **다음 작업.**
